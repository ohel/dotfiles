...
# Wired.
xinput set-button-map "Keychron Keychron M6" 1 12 3 4 5 6 7 10 11 2>/dev/null
xinput set-prop "Keychron Keychron M6" "libinput Accel Speed" 0.25 2>/dev/null
# Bluetooth.
xinput set-button-map "Keychron M6 Mouse" 1 12 3 4 5 6 7 10 11 2>/dev/null
xinput set-prop "Keychron M6 Mouse" "libinput Accel Speed" 0.25 2>/dev/null
