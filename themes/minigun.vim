...
hi Folded		guibg=#000000 guifg=#ffffff gui=none ctermfg=015 ctermbg=000
hi vimFold		guibg=#000000 guifg=#ffffff gui=none ctermfg=015 ctermbg=000
hi FoldColumn	guibg=#000000 guifg=#ffffff gui=none ctermfg=015 ctermbg=000
...
hi VertSplit	guibg=#3a3a3a guifg=#3a3a3a gui=none ctermfg=237 ctermbg=237
hi StatusLine   guifg=#ffffff guibg=#3a3a3a gui=none ctermfg=015 ctermbg=237
hi StatusLineNC guifg=#808080 guibg=#3a3a3a gui=none ctermfg=244 ctermbg=237
...
hi MatchParen	guibg=#585858 guifg=#ffffff ctermbg=240 ctermfg=015
